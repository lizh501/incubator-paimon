...
//        rocksDBStateBackend.setPredefinedOptions(PredefinedOptions.SPINNING_DISK_OPTIMIZED_HIGH_MEM);
        ...
        String checkpointPath =
                "file:///C:\\Users\\lizh501\\Desktop\\Work\\CUBD\\Code\\checkpoints\\paimon-0.7/";
        ...
        env.executeSql(
                "CREATE CATALOG paimon_catalog WITH (\n"
                        + "    'type'='paimon',\n"
                        + "    'warehouse'='file:///C:/Users/lizh501/Desktop/Work/CUBD/Code/data/paimon/catalog-0.7'\n"
                        + ");");

        env.executeSql("use catalog paimon_catalog;");

        env.executeSql(
                "CREATE TABLE IF NOT EXISTS user_info_20231128(\n"
                        + " id STRING,\n"
                        + " name STRING,\n"
                        + " age INT,\n"
                        + " sex STRING,\n"
...
//                env.executeSql("INSERT INTO user_info_20230627(id, age, dt) values('1', 23, 202308081712);");
        ...
        env.executeSql("INSERT INTO user_info_20231128 SELECT * FROM InputTable");
